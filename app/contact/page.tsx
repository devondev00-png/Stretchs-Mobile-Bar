        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] items-start">
          ...
          <div>
            ...
            <div className="card-elevated p-6">
              <h3 className="font-semibold text-zinc-900">What to include</h3>
            ...
            <div className="mt-6 card-elevated p-6">
              <h3 className="font-semibold text-zinc-900">Direct contact</h3>
              <div className="mt-4 space-y-3 text-sm text-zinc-600">
                {settings?.email && (
                  <a
                    href={`mailto:${settings.email}`}
                    className="flex items-center gap-3 hover:text-zinc-900 no-underline transition-colors"
                  >
